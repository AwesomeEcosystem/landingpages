<template>
  <div class="flex justify-between items-center w-64">
    <div v-if="days" class="">
      <div class="text-4xl">{{ days | twoDigits }}</div>
      <div class="">Days</div>
    </div>:
    <div class="">
      <div class="text-4xl">{{ hours | twoDigits }}</div>
      <div class="">Hours</div>
    </div>:
    <div class="">
      <div class="text-4xl">{{ minutes | twoDigits }}</div>
      <div class="">Minutes</div>
    </div>:
    <div class="">
      <div class="text-4xl">{{ seconds | twoDigits }}</div>
