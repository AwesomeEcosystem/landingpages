<template>
  <div class="py-24">
    ...
    <button class="bg-black btn text-white flex items-center" @click="buy()" v-if="!buying">Buy</button>
    <google-pay-button
      environment="TEST"
      button-type="buy"
      button-color="black"
        ...
        allowedPaymentMethods: [
          {
            ...
            tokenizationSpecification: {
              type: 'DIRECT',
              parameters: {
                merchantName: 'ecosis Network Ltd',
                gatewayMerchantId: 'BCR2DN4TYCXO3GJ5'
              }
            }
          }
        ],
