            ...
            <div class="row ">
                <div class="col-md-6">
                    <div class="hero-content">
                        <h6 class="hero-content-subtitle mt-20">The ultimate</h6>
                        <h2 class="h1 hero-content-title">Rewarding <br> Marketplace</h2>
                        <h6 class="hero-content-subtitle mt-20"> Purchasing Power to the People!</h6>

                        <div class="slider-button mt-30">
                            <a class="btn btn--gradient-hot" href="https://kcha60ohz1u.typeform.com/to/ShJeY8a2" target="_blank">Whitelist</a>
