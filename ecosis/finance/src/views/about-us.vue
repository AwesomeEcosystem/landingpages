<template>
    <div>
        ...
        <section class="relative pt-14 lg:pb-48 lg:pt-[100px]">
            ...
            >
                <img src="/assets/images/about-who-bg.png" alt="about-who-bg" class="rtl:rotate-y-180" />
            </div>
        </section>
                    ...
                    <div data-aos="fade-up" data-aos-duration="1000">
                        ...
                        >
                            ...
                            <div>
                                ...
                                <p class="text-sm font-semibold text-black dark:text-gray">There are many variations of passages of Lorem Ipsum available</p>
                            </div>
                        </div>
                    </div>
                    <div data-aos="fade-up" data-aos-duration="1000">
                        ...
                        >
                            ...
                            <div>
                                ...
                                <p class="text-sm font-semibold text-black dark:text-gray">Contrary to popular belief, Lorem Ipsum is not simply random text</p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="container">
                ...
                <div class="grid gap-4 sm:grid-cols-3 md:gap-[30px]">
                    <div data-aos="fade-up" data-aos-duration="1000">
                        ...
                        >
                            <div class="mx-auto xl:w-1/2">
                                <h2 class="mb-4 text-4xl font-black text-secondary dark:group-hover:text-black md:mb-0 md:text-6xl md:leading-[75px]">90%</h2>
                    ...
                    <div data-aos="fade-up" data-aos-duration="1000">
                        ...
                        >
                            <div class="mx-auto xl:w-1/2">
                                <h2 class="mb-4 text-4xl font-black text-secondary dark:group-hover:text-black md:mb-0 md:text-6xl md:leading-[75px]">10x</h2>
                                <p class="text-sm font-bold text-gray-dark line-clamp-2 dark:text-white dark:group-hover:text-black">
                    ...
                    <div data-aos="fade-up" data-aos-duration="1000">
                        ...
                        >
                            <div class="mx-auto xl:w-1/2">
                                <h2 class="mb-4 text-4xl font-black text-secondary dark:group-hover:text-black md:mb-0 md:text-6xl md:leading-[75px]">4.4M</h2>
                                <p class="text-sm font-bold text-gray-dark line-clamp-2 dark:text-white dark:group-hover:text-black">
                ...
                <div class="grid gap-4 pt-5 sm:grid-cols-3 md:gap-[30px] lg:grid-cols-4 lg:pt-0">
                    <div data-aos="fade-up" data-aos-duration="1000">
                        <div class="rounded-[32px] border border-transparent bg-white py-9 px-4 transition hover:border-secondary">
                            <img src="/assets/images/award-1.png" alt="award-1" class="mx-auto h-[100px]" />
                        </div>
                    </div>
                    <div data-aos="fade-up" data-aos-duration="1000">
                        <div class="rounded-[32px] border border-transparent bg-white py-9 px-4 transition hover:border-secondary">
                            <img src="/assets/images/award-2.png" alt="award-2" class="mx-auto h-[100px]" />
                        </div>
                    </div>
                    <div data-aos="fade-up" data-aos-duration="1000">
                        <div class="rounded-[32px] border border-transparent bg-white py-9 px-4 transition hover:border-secondary">
                            <img src="/assets/images/award-3.png" alt="award-3" class="mx-auto h-[100px]" />
                        </div>
                    </div>
                    <div data-aos="fade-up" data-aos-duration="1000">
                        <div class="rounded-[32px] border border-transparent bg-white py-9 px-4 transition hover:border-secondary">
                            <img src="/assets/images/award-4.png" alt="award-4" class="mx-auto h-[100px]" />
                        </div>
                    </div>
                    <div data-aos="fade-up" data-aos-duration="1000">
                        <div class="rounded-[32px] border border-transparent bg-white py-9 px-4 transition hover:border-secondary">
                            <img src="/assets/images/award-5.png" alt="award-5" class="mx-auto h-[100px]" />
                        </div>
                    </div>
                    <div data-aos="fade-up" data-aos-duration="1000">
                        <div class="rounded-[32px] border border-transparent bg-white py-9 px-4 transition hover:border-secondary">
                            <img src="/assets/images/award-6.png" alt="award-6" class="mx-auto h-[100px]" />
                        </div>
                    </div>
                    <div data-aos="fade-up" data-aos-duration="1000">
                        <div class="rounded-[32px] border border-transparent bg-white py-9 px-4 transition hover:border-secondary">
                            <img src="/assets/images/award-7.png" alt="award-7" class="mx-auto h-[100px]" />
                        </div>
                    </div>
                    <div data-aos="fade-up" data-aos-duration="1000">
                        <div class="rounded-[32px] border border-transparent bg-white py-9 px-4 transition hover:border-secondary">
                            <img src="/assets/images/award-8.png" alt="award-8" class="mx-auto h-[100px]" />
                        </div>
                    </div>
                </div>
            </div>
        ...
        <section class="relative overflow-x-hidden border-t-2 border-transparent py-14 dark:border-gray/20 lg:py-[100px]">
            <div class="container">
                <div class="relative">
                        ...
                        <div class="top-20 ltr:left-[105%] rtl:right-[105%] xl:absolute">
                            ...
                            >
                                ...
                                <path
                                    ...
                                    stroke-linejoin="round"
                                />
                                <path d="M319 81.0817L298.518 75.1416" stroke="#7780A1" stroke-width="0.75" stroke-linecap="round" stroke-linejoin="round" />
                                <path
                    ...
                    <form action="" class="relative z-[1] pt-[50px] text-center ltr:xl:text-left rtl:xl:text-right" data-aos="fade-up" data-aos-duration="1000">
