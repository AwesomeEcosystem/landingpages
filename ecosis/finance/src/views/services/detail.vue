<template>
    <div>
            ...
            <div class="relative">
                <div class="container">
                    <div class="relative items-center py-14 lg:flex lg:py-[100px]">
                        <div class="relative z-[1] text-center text-white lg:w-3/5 ltr:lg:text-left rtl:lg:text-right xl:w-3/5">
                            <h2 class="text-4xl font-black sm:text-5xl sm:leading-[126px] xl:text-[100px]">UI/UX Design</h2>
                            <p class="my-8 text-xl leading-[40px] text-[#7780A1]">
                                The AppStoneLab team handles the full cycle of mobile app and website design services. We produce only top-notch applications
                                and websites with great design UX, UI, navigation, and functionality.
                            </p>
                            <router-link to="/about-us" class="btn mt-2 capitalize text-white">Book a free consultation</router-link>
                        </div>
                        <div
                        ...
                        >
                            <img src="/assets/images/services-detail-phone.png" alt="services-detail-phone" class="mx-auto h-full" />
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="container">
                <div class="heading text-center lg:w-7/12 ltr:lg:text-left rtl:lg:text-right">
                    ...
                    <p class="mt-4 text-lg font-semibold">
                        We combine our team’s depth of experience in design, our client’s intimate knowledge of the industries they serve and insights uncovered
                ...
                <ul>
                    ...
                    <li class="flex border-t-2 border-black/5 py-10 dark:border-gray-dark lg:items-center">
                        ...
                        <div class="lg:w-4/6">
                            ...
                            <p class="text-lg font-semibold">
                                We pay a lot of attention to the visual solution so that it is also attractive and in line with modern market requirements in
                                addition to being comfortable to use.
                            </p>
                        </div>
                    </li>
                    <li class="flex border-t-2 border-black/5 py-10 dark:border-gray-dark lg:items-center">
                    ...
                    <li class="flex border-t-2 border-black/5 pt-10 dark:border-gray-dark lg:items-center">
                        ...
                        <div class="lg:w-4/6">
                            ...
                            <p class="text-lg font-semibold">
                                We significantly reduce the task completion time, allowing users to do their jobs in fewer clicks, thus contributing to better
        ...
        <section class="py-14 lg:py-[100px]">
            <div class="container">
                <div class="mb-10 flex flex-col items-center justify-center gap-4 lg:mb-14 lg:flex-row lg:justify-between">
                ...
                <div class="grid gap-[30px] sm:grid-cols-2">
                    <div
                        class="group relative rounded-[32px] border border-transparent drop-shadow-[5px_10px_100px_rgba(8,17,31,0.06)] transition duration-500 hover:border-secondary"
                        data-aos="fade-up"
                        data-aos-duration="1000"
                    >
                        <router-link to="/portfolio-detail" class="absolute top-0 z-[1] h-full w-full ltr:left-0 rtl:right-0"></router-link>
                        <div class="rounded-t-[32px] md:h-[355px]">
                            <img src="/assets/images/cases-1.png" alt="cases-1" class="mx-auto h-full w-full rounded-t-[32px] object-cover" />
                        </div>
                        <div class="rounded-b-[32px] bg-white p-5 transition duration-500 group-hover:bg-secondary/5 dark:bg-gray-dark">
                            <h4 class="text-lg font-bold text-black dark:text-white md:text-xl">Integer ornare nisi vitae risus vulputate</h4>
                            <h5 class="mt-2 font-semibold md:text-lg">Website</h5>
                        </div>
                    </div>
                    <div
                        class="group relative rounded-[32px] border border-transparent drop-shadow-[5px_10px_100px_rgba(8,17,31,0.06)] transition duration-500 hover:border-secondary"
                    ...
                    >
                        <router-link to="/portfolio-detail" class="absolute top-0 z-[1] h-full w-full ltr:left-0 rtl:right-0"></router-link>
                        <div class="rounded-t-[32px] md:h-[355px]">
                            <img src="/assets/images/cases-2.png" alt="cases-2" class="mx-auto h-full w-full rounded-t-[32px] object-cover" />
                        </div>
                        <div class="rounded-b-[32px] bg-white p-5 transition duration-500 group-hover:bg-secondary/5 dark:bg-gray-dark">
                            <h4 class="text-lg font-bold text-black dark:text-white md:text-xl">Morbi vehicula metus a purus dapibu</h4>
                            <h5 class="mt-2 font-semibold md:text-lg">Website</h5>
                        </div>
                    </div>
                    <div
                    ...
                    >
                        <router-link to="/portfolio-detail" class="absolute top-0 z-[1] h-full w-full ltr:left-0 rtl:right-0"></router-link>
                        <div class="rounded-t-[32px] md:h-[355px]">
                            <img src="/assets/images/cases-3.png" alt="cases-3" class="mx-auto h-full w-full rounded-t-[32px] object-cover" />
                        </div>
                        <div class="rounded-b-[32px] bg-white p-5 transition duration-500 group-hover:bg-secondary/5 dark:bg-gray-dark">
                            <h4 class="text-lg font-bold text-black dark:text-white md:text-xl">Pellentesque imperdiet dui eget ante egestas</h4>
                            <h5 class="mt-2 font-semibold md:text-lg">Website</h5>
                        </div>
                    </div>
                    <div
                    ...
                    >
                        <router-link to="/portfolio-detail" class="absolute top-0 z-[1] h-full w-full ltr:left-0 rtl:right-0"></router-link>
                        <div class="rounded-t-[32px] md:h-[355px]">
                            <img src="/assets/images/cases-4.png" alt="cases-4" class="mx-auto h-full w-full rounded-t-[32px] object-cover" />
                        </div>
                        <div class="rounded-b-[32px] bg-white p-5 transition duration-500 group-hover:bg-secondary/5 dark:bg-gray-dark">
                            <h4 class="text-lg font-bold text-black dark:text-white md:text-xl">Mauris non lorem quis erat</h4>
                            <h5 class="mt-2 font-semibold md:text-lg">Website</h5>
                        </div>
                    </div>
                    <div
                        class="group relative rounded-[32px] border border-transparent drop-shadow-[5px_10px_100px_rgba(8,17,31,0.06)] transition duration-500 hover:border-secondary sm:col-span-2"
                        data-aos="fade-up"
                        data-aos-duration="1000"
                    >
                        <router-link to="/portfolio-detail" class="absolute top-0 z-[1] h-full w-full ltr:left-0 rtl:right-0"></router-link>
                        <div class="rounded-t-[32px] md:h-[606px]">
                            <img src="/assets/images/cases-5.png" alt="cases-5" class="h-full w-full rounded-t-[32px] object-cover" />
                        </div>
                        <div class="rounded-b-[32px] bg-white p-5 transition duration-500 group-hover:bg-secondary/5 dark:bg-gray-dark">
                            <h4 class="text-lg font-bold text-black dark:text-white md:text-xl">Pellentesque imperdiet dui eget ante egestas</h4>
                            <h5 class="mt-2 font-semibold md:text-lg">Website</h5>
        ...
        <section class="py-14 dark:bg-gray-dark lg:py-[100px]">
            <div class="container">
                <div class="relative z-10 lg:flex">
                    <div class="heading text-center rtl:pl-10 lg:mb-0 lg:w-1/3 ltr:lg:pr-10 ltr:lg:text-left rtl:lg:text-right">
                        <h6>Get In Touch.</h6>
