                ...
                <div class="grid gap-x-[30px] gap-y-10 sm:grid-cols-2 lg:grid-cols-3">
                    <div data-aos="fade-up" data-aos-duration="1000">
                        ...
                        >
                            ...
                            <img src="/assets/images/blog-1.png" alt="blog-1" class="h-52 w-full rounded-t-3xl object-cover" />
                    ...
                    <div data-aos="fade-up" data-aos-duration="1000">
                        ...
                        >
                            <router-link to="/blog-details" class="absolute top-0 h-full w-full ltr:left-0 rtl:right-0"></router-link>
                            <img src="/assets/images/blog-2.png" alt="blog-2" class="h-52 w-full rounded-t-3xl object-cover" />
                            <div class="p-5 text-sm font-bold">
                    ...
                    <div data-aos="fade-up" data-aos-duration="1000">
                        ...
                        >
                            <router-link to="/blog-details" class="absolute top-0 h-full w-full ltr:left-0 rtl:right-0"></router-link>
                            <img src="/assets/images/blog-3.png" alt="blog-3" class="h-52 w-full rounded-t-3xl object-cover" />
                            <div class="p-5 text-sm font-bold">
