        ...
        <section class="py-14 md:py-[100px]">
            <div class="container">
                                    ...
                                    <svg width="134" height="130" viewBox="0 0 134 130" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <g opacity="0.3" filter="url(#filter0_f_866_3412)">
                                            ...
                                            <path
                                                ...
                                                fill="#FDAD00"
                                            />
                                            <path fill-rule="evenodd" clip-rule="evenodd" d="M50 60.6972L57.2332 50.9873L56.7141 60.6972H50Z" fill="#FDAD00" />
                                            <path fill-rule="evenodd" clip-rule="evenodd" d="M66.5747 50L56.7129 60.6975H76.4366L66.5747 50Z" fill="#EA6C00" />
                                        </g>
                                        <path fill-rule="evenodd" clip-rule="evenodd" d="M56.7141 60.6973L66.576 79.9998L50 60.6973H56.7141Z" fill="#EA6C00" />
                                        <path
                                            fill-rule="evenodd"
                                            clip-rule="evenodd"
                                            d="M76.4382 60.6973L66.5764 79.9998L83.1523 60.6973H76.4382Z"
                                        ...
                                        />
                                        <path fill-rule="evenodd" clip-rule="evenodd" d="M50 60.6972L57.2332 50.9873L56.7141 60.6972H50Z" fill="#FDAD00" />
                                        <path fill-rule="evenodd" clip-rule="evenodd" d="M66.5747 50L56.7129 60.6975H76.4366L66.5747 50Z" fill="#FEEEB7" />
                                        <defs>
                                            <filter
                ...
                <div class="grid gap-[30px] sm:grid-cols-2">
                    <img src="/assets/images/portfolio-img-1.png" alt="portfolio-img-1" class="rounded-[32px]" data-aos="fade-up" data-aos-duration="1000" />
                    <img src="/assets/images/portfolio-img-2.png" alt="portfolio-img-2" class="rounded-[32px]" data-aos="fade-up" data-aos-duration="1000" />
                </div>
                <div class="py-[30px] sm:py-[50px]">
                    <img src="/assets/images/portfolio-img-3.png" alt="portfolio-img-3" class="rounded-[32px]" data-aos="fade-up" data-aos-duration="1000" />
                </div>
                <div>
                    <img src="/assets/images/portfolio-img-4.png" alt="portfolio-img-4" class="rounded-[32px]" data-aos="fade-up" data-aos-duration="1000" />
                </div>
            </div>
        </section>
