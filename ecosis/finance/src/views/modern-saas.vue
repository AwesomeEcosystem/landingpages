<template>
    <div class="overflow-x-hidden">
        ...
        <section class="bg-gradient-to-t from-white/[55%] to-transparent py-8 px-5 dark:bg-white/[0.03] dark:bg-none lg:py-20">
            <div class="relative mx-auto max-w-[1440px] rounded-[32px] bg-black pt-14">
            ...
            <div class="container">
                ...
                >
                    <div class="heading mb-5 text-center ltr:lg:text-left rtl:lg:text-right">
                        ...
                        <p class="mt-6 text-lg font-semibold">
                            Optimize your SaaS solutions’ tenancy by leveraging our deep understanding of the unit economics of SaaS products. We can take
                            existing single-tenant applications and securely deliver a cost optimized multi-tenant solution.
                        </p>
                        <a
                            href="javascript:"
                ...
                >
                    <div class="heading mb-5 text-center ltr:lg:text-left rtl:lg:text-right">
                        ...
                        <p class="mt-6 text-lg font-semibold">
                            Migrating a legacy system involves taking your old infrastructure and transferring it to the cloud. This does provide potential cost
                            and efficiency benefits. However, it fails to give your application a growth perspective.
                        </p>
                        <a
                            href="javascript:"
            ...
            <div class="container">
                ...
                <div class="grid gap-14 sm:grid-cols-2 lg:grid-cols-3">
                    <div data-aos="fade-up" data-aos-duration="1000">
                        ...
                        <router-link to="/services-detail" class="text-lg font-extrabold text-secondary transition hover:text-primary">Read More +</router-link>
                    </div>
                    <div data-aos="fade-up" data-aos-duration="1000">
                        <div class="mb-10">
                        ...
                        <p class="mt-6 mb-8 text-lg font-semibold line-clamp-4">
                            Design and simplicity are at the core of our website builder. Easily create, customize, and promote a stunning website that's
                            search...
                        </p>
                        <router-link to="/services-detail" class="text-lg font-extrabold text-primary transition hover:text-secondary">Read More +</router-link>
                    </div>
                    <div data-aos="fade-up" data-aos-duration="1000">
                        <div class="mb-10">
        ...
        <blog-slider
            ...
            :blogs="blogs"
            title="Blog"
            sub-title="Unlock the latest trends/news"
        ></blog-slider>
        ...
        <section class="relative bg-black py-14 lg:py-24">
            ...
            <div class="container">
                <div class="flex flex-col justify-between gap-8 md:flex-row">
                    ...
                    <div :data-aos="store.direction === 'rtl' ? 'fade-right' : 'fade-left'" data-aos-duration="1000">
