                ...
                <div class="row">
                    <div class="col-lg-12 wow move-up">
                        <div class="section-title-wrapper text-center section-space--mb_60">
                            <h2 class="section-title text-white font-width-light mb-15  wow move-up">Say hello to your finance on steriods.</h2>
                            <p class="text-white wow move-up">Get the most out of your finance.</p>
                        </div>
                    </div>
                </div>
            </div>
                                ...
                                <div class="col-lg-6">
                                    <div class="payment-process-step__content float-md-right">
                                        <div class="payment-process__inner">
                                            <h4 class="font-weight--blod section-space--mb_40">Effortless Finance Manager
                                                <sup>01</sup>
                                            </h4>
                                            <div class="sub-text section-space--mb_40">
                                                Manage your budget, track and monitor transactions, and create vaults across the ecosis network.
                                            </div>
                                            <!-- <div class="payment-process-btn section-space--mb_40">
                                                <a href="#" class="ht-btn ht-btn-md"><i class="fa mr-2"></i> Whitelist</a>
                                                <h6 class="sub-heading">Questions? <a href="#" class="hover-style-link hover-style-link--green">Join our community!</a></h6>
                                            </div> -->
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="row align-items-center">
                                <div class="col-lg-5 order-2 order-lg-1">
                                    <div class="payment-process-step__content float-md-left">
                                        <div class="payment-process__inner">
                                            <h4 class="font-weight--blod section-space--mb_40">Powerful Payment Gateway
                                                <sup>02</sup>
                                            </h4>
                                            <ul class="check-list green-check-list section-space--mt_30">
                                              <li class="list-item">Compatible with Paypal and Revolut</li>
                                              <li class="list-item">Compatible with Shopify</li>
                                              <li class="list-item">ecosis Reward System inbuild</li>
                                            </ul>
