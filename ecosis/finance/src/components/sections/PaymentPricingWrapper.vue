<template>
    <div class="payment-staps-pricing_wrapper payment-pricing-table-bg" id="pricing-section">
                                    ...
                                    <div class="row align-items-center">
                                        <div class="col-lg-6 col-md-12  wow move-up">
                                            <div class="payment-process-step__media text-center">
                                                <img src="../../assets/img/screenshots/dev_package3.png" class="img-fluid" alt="">
                                            </div>
                                        </div>
                                        <div class="col-lg-6 col-md-12  wow move-up">
                                            <div class="payment-process-step__content float-md-right">
                                                <div class="payment-process__inner">
                                                    <h4 class="font-weight--blod section-space--mb_40">Profit Maximization
                                                        <sup>03</sup>
                                                    </h4>
                                                    <div class="sub-text section-space--mb_40">
                                                        One click enables Liquidity Providing and Lending to get more out of your ecosis network rewards.
                                                    </div>
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-6 col-sm-6">
                                                                <div class="fun-fact--three ">
                                                                    ...
                                                                    <h6 class="fun-fact__text">Swaps</h6>
                                                                </div>
                                                            </div>
                                                            <div class="col-md-6 col-sm-6">
                                                                <div class="fun-fact--three">
                                                                    ...
                                                                    <h6 class="fun-fact__text">Whitelist</h6>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div> -->
            ...
            <!--========= Pricing  Table Area ===========-->
            <div class="pricing-table-area section-space--pb_120 position-relative" id="exchange">
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="section-title-wrapper text-center section-space--mb_60">
                                    <h2 class="section-title text-white font-width-light mb-15 wow move-up">Crypto Exchange</h2>
                                    <p class="text-white wow move-up">Exchange any Crypto-Asset on-the-fly</p>
                                </div>
                            </div>
                        </div>
                    </div>
