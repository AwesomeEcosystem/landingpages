                ...
                <div class="row footer-widget-wrapper">
                    ...
                    <div class="col-lg-3 col-md-6 footer-widget">
                        ...
                        <ul class="footer-widget__list">
                            ...
                            <li>
                                <router-link to="/eco" class="hover-style-link">Exchange</router-link>
                            </li>
                            <li>
                                <router-link to="/eco" class="hover-style-link">Liquidity Providing</router-link>
                            </li>
                            <li>
                                ...
                                <div class="swiper-wrapper twitter-feed-slider__wrapper">
                                    <div class="swiper-slide twitter-feed-slider__single">
                                        <div class="tweet">
                                            ...
                                            <div class="">
                                                <h6 class="tweet__heading"><a href="https://www.linkedin.com/company/ecosiss/" target="_blank">ecosis on LinkedIn</a></h6>
