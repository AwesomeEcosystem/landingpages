                    ...
                    <swiper-slide class="bg-cover slider-1">
                        <div class="hero-item">
                            <div class="hero-content text-center">
                                <h4 class="hero-content-subtitle">We a network of experts helping you to</h4>
                                <h2 class="h1 hero-content-title">Build your Business</h2>
                                <!-- <div class="hero-btn">
                    ...
                    <swiper-slide class="bg-cover slider-2">
                        <div class="hero-item">
                            <div class="hero-content text-center">
                                ...
                                <h2 class="h1 hero-content-title">Let us support you to build your business</h2>
                                <!-- <h6 class="sub-heading">
                                    Questions?
                                    <router-link to="#about" class="hover-style-link hover-style-link--green">Talk to our team</router-link>
                                </h6> -->
                            </div>
                        </div>
                    </swiper-slide>
